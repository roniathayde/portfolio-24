        ...
        <section>
          ...
          <article className="mt-8  flex w-full flex-wrap justify-between  gap-6">
            <div className="min-w-[270px]">
              <header className="mb-3 font-semibold text-slate-800">
                💻 Áreas de Expertise
              </header>
              <ul>
                <li className="text-base font-medium text-slate-600">
            ...
            <div className="min-w-[270px]">
              ...
              <ul>
                <li className="text-base font-medium text-slate-600">NextJS</li>
                <li className="text-base font-medium text-slate-600">NodeJS</li>
                <li className="text-base font-medium text-slate-600">Docker</li>
                <li className="text-base font-medium text-slate-600">
                  SEO (Search Engine Optimaztion)
                </li>
              </ul>
            ...
            <div className="min-w-[270px]">
              ...
              <ul>
                <li className="text-base font-medium text-slate-600">Luta</li>
                <li className="text-base font-medium text-slate-600">
                  Desenhar
                </li>
                <li className="text-base font-medium text-slate-600">
