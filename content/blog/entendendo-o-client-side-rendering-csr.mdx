...
![Explicação do fluxo de requisições e respostas](/public/images/primeira-chamada.jpg)
...
![GIF explicativo](/public/images/gif-minion.gif)
...
- O cliente, ao ler o HTML, encontra um arquivo chamado `script.js` (esse cara é brabo) e pede esse arquivo para o servidor.
    ...
    ![Cliente pedindo script.js](/public/images/segunda-chamada.jpg)

- O servidor encontra esse arquivo `script.js` e o retorna para o cliente.

    ![Servidor retornando script.js](/public/images/terceira-chamada.jpg)

- O cliente, agora com o JavaScript na mão, monta toda a página interativa.

![Página interativa montada](/public/images/quarta-chamada.jpg)
